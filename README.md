<div align="center">
    <a href="https://obinna.xyz"><h1 align="center">obinna.xyz</h1></a>
...
```sh-session
git clone https://github.com/obiknows/me.git
cd me
```

Create an Upstash Account and create a database.

Create a `.env` file similar to [`.env.example`](https://github.com/chronark/chronark.com/blob/main/.env.example) using the data from your new Upstash database.
